...
class Config:
  ...
  batch_size_random: int = 1024  # The number of rays/pixels in each batch.
  ...
  render_chunk_size: int = 1024  # Chunk size for whole-image renderings.
  ...
  raydepth_nll_weight: float = 0.001  # How much to downweight the ray depth nll loss.
  remodel_nll_weight: float = 0.0001 # How much to downweight the remodeled nll loss.
  ############## mixnerf ##############
  ...
  raydepth_nll_loss: bool = False # Whether to use ray depth nll loss.
  remodel_nll_loss: bool = False # Whether to use remodeled nll loss.
  ############## mixnerf ##############
